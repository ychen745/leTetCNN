...
if __name__ == '__main__':
    ...
    if args.landmark:
        train_loader, test_loader = util_lm.load_data(args.pos, args.neg, args.n_workers, True, args.n_lmk, args.bnn, args.load, args.fold, args.n_fold)
    else:
        train_loader, test_loader = util_lm.load_data(args.pos, args.neg, args.n_workers, False, None, None, args.load, args.fold, args.n_fold)
    ...
    for epoch in range(1, args.n_epoch+1):
        ...
        print('Epoch: {:02d}, Time taken: {} sec, Train loss: {:.4f}, Val loss: {:.4f}, Test loss: {:.4f}, Train acc: {:.4f}, Test acc: {:.4f}, Test sen: {:.4f}, Test spe: {:.4f}, Test prec: {:.4f}'.format(epoch, time.time() - epoch_start_time, train_loss, val_loss, test_loss, tr_acc, test_acc,test_sen,test_spe,test_prec))
