...
if __name__ == '__main__':
    ...
    train_set = PointDataSet(args.pos, args.neg, args.group, True, 3)
    test_set = PointDataSet(args.pos, args.neg, args.group, False, 3)
    ...
    model = pointnet_cls.get_model(normal_channel=False).to(device)
