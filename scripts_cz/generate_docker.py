            ...
            for network in networks:
                for pair in exp_pairs:
                    ...
                    for file_pair in pos_neg:
                        ...
                        if landmark:
                            out_lines.append('#SBATCH -o /data/hohokam/Yanxi/Code/leTetCNN/scripts_cz/job_logs/' + str(pos_name) + '_' + str(neg_name) + '_' + str(n_lmk) + '_' + str(k) + '_' + network + '_' + str(fold) + '.out')
                            out_lines.append('#SBATCH -e /data/hohokam/Yanxi/Code/leTetCNN/scripts_cz/job_logs/' + str(pos_name) + '_' + str(neg_name) + '_' + str(n_lmk) + '_' + str(k) + '_' + network + '_' + str(fold) + '.err')
                        else:
                            out_lines.append('#SBATCH -o /data/hohokam/Yanxi/Code/leTetCNN/scripts_cz/job_logs/' + str(pos_name) + '_' + str(neg_name) + '_tetcnn' + '_' + str(fold) + '.out')
                            out_lines.append('#SBATCH -e /data/hohokam/Yanxi/Code/leTetCNN/scripts_cz/job_logs/' + str(pos_name) + '_' + str(neg_name) + '_tetcnn' + '_' + str(fold) + '.err')
