...
#SBATCH --mem=128G
#SBATCH -q grp_rwang133
#SBATCH -G h100:1
#SBATCH -t 1-00:00:00                  # wall time (D-HH:MM)
#SBATCH -o /data/hohokam/Yanxi/Code/leTetCNN/scripts_cz/job_logs/ad_mci_tetcnn_0.out
#SBATCH -e /data/hohokam/Yanxi/Code/leTetCNN/scripts_cz/job_logs/ad_mci_tetcnn_0.err
